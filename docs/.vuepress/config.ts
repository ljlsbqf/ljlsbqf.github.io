...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    logo: '', // 导航栏logo
    repo: 'https://github.com/ljlsbqf', // 导航栏右侧生成Github链接
    ...
    footer: {
      ...
      copyrightInfo:
        '<a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
